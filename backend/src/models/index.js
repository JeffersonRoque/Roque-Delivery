...
const EmpresaProduto = require('./empresaProduto.js');
const EmpresaSubproduto = require('./empresaSubproduto.js');
...
EmpresaProduto.init(sequelize);
EmpresaSubproduto.init(sequelize);
...
EmpresaProduto.associate?.(sequelize.models);
EmpresaSubproduto.associate?.(sequelize.models);
